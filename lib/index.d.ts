...
export * from './definitions/navigation.types.js';
...
export declare const chatEventBuss: {
    ...
    register: <Key extends keyof IChatEventBus>(event: Key, callback: (val: IChatEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const artifactEventBuss: {
    ...
    register: <Key extends keyof IArtifactEventBus>(event: Key, callback: (val: IArtifactEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const notificationEventBuss: {
    ...
    register: <Key extends keyof INotificationEventBus>(event: Key, callback: (val: INotificationEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const calendarEventBuss: {
    ...
    register: <Key extends keyof ICalendarEventBus>(event: Key, callback: (val: ICalendarEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const tasksEventBuss: {
    ...
    register: <Key extends "on_open_tasks">(event: Key, callback: (val: ITasksEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const directoryEventBuss: {
    ...
    register: <Key extends keyof IDirectoryEventBus>(event: Key, callback: (val: IDirectoryEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const oaDirectoryEventBuss: {
    ...
    register: <Key extends keyof IAoAppDirectoryEventBus>(event: Key, callback: (val: IAoAppDirectoryEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const consentsEventBuss: {
    ...
    register: <Key extends keyof IConsentsEventBus>(event: Key, callback: (val: IConsentsEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const msOfficeEventBuss: {
    ...
    register: <Key extends "login">(event: Key, callback: (val: IMsOfficeEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const asmaOverridesEventBus: {
    ...
    register: <Key extends keyof IAsmaOverrides>(event: Key, callback: (val: IAsmaOverrides[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const navigationEventBus: {
    ...
    register: <Key extends keyof INavigationEventBus>(event: Key, callback: (val: INavigationEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const legacyPortalEventBus: {
    ...
    register: <Key extends keyof ILegacyPortalEventBus>(event: Key, callback: (val: ILegacyPortalEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
export declare const crmEventBus: {
    ...
    register: <Key extends keyof ICrmEventBus>(event: Key, callback: (val: ICrmEventBus[Key]) => void | Promise<any>) => {
        unregister: () => void;
    };
};
